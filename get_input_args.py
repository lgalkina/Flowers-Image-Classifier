...
#     5. Dropout as --dropout with default value 0.5
#     6. Number of Epochs as --epochs with default value 20
#     7. Path to save checkpoint to as --checkpoint_path with default value './checkpoint.pth'
#     8. Processing unit --process_unit with default value 'gpu'
...
def get_input_args_to_train():
    ...
    parser.add_argument('--hidden_units', type=int, action="append", default=[512],
                        help='hidden units, pass several times to add hidden units')
